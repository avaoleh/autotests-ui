...
class ChartViewComponent(BaseComponent):
    ...
    def check_visible(self, expected_title: str) -> None:
        """
        Checks if the chart component is visible with correct title
        :param expected_title: The expected title text to verify
        """
